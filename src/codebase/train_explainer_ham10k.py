...
from Explainer.experiments_explainer_ham10k import train
...
parser.add_argument('--concepts', nargs='+',
                    default=["Sex", "BWV", "RegularDG", "IrregularDG", "RegressionStructures",
...
parser.add_argument('--test', default='n', type=str, metavar='N', help='trying diff seeds for paper')

parser.add_argument('--profile', default='n', type=str, metavar='N', help='trying diff seeds for paper')


def main():
    print("Train GLT for HAM10k")
    args = parser.parse_args()
    args.class_to_idx = {"benign": 0, "malignant": 1}
    print("Training explainer for Skin")
    train(args)

...
import numpy as np
from Explainer.experiments_explainer_mimic_cxr_icml import train_glt_icml
...
parser.add_argument('--epochs-residual', type=int, default=1, help='epoch size for training the residual')

...
from BB.experiments_t_mimic_cxr import train_t, test_t
...
parser.add_argument('--checkpoint-bb', metavar='file', default='model_seq_epoch_6.pth.tar',
                    help='checkpoint file of BB')

parser.add_argument('--checkpoint-t', metavar='file', default='model_seq_epoch_19.pth.tar',
                    help='checkpoint file of BB')

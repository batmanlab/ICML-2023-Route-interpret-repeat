...
class Logger_CUBS:
    ...
    def __init__(
        ...
        self.val_g_auroc = None
        self.val_bb_auroc = None
    ...
    def evaluate_g_correctly_auroc(self, selection_threshold, expert="explainer"):
        prediction_result = self.val_out_put_class.argmax(dim=1)
        t = self.val_out_put_target.detach()
        selection_result = None
        if self.val_out_put_sel_proba is not None:
    ...
    def track_val_bb_outputs(self, out_class_bb):
    ...
    def get_final_BB_val_auroc(self):
        return self.val_bb_auroc

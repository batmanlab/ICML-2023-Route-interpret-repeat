...
def train(args, model, chk_pt_path, output_path, tb_logs_path):
    ...
    train_loader, test_loader = get_loader(args, mode="train")
...
def main():
    ...
    parser.add_argument("--dataset", choices=["awa2", "CUB_200_2011", "car", "dog", "nabirds", "INat2017", "DLCV_1"],
                        default="awa2",
                        help="Which dataset.")
    ...
    parser.add_argument('--concept-names', nargs='+',
                        default=["black",
                                 "white", "blue", "brown", "gray", "orange", "red", "yellow", "patches", "spots",
                                 "stripes",
                                 "furry", "hairless", "toughskin", "big", "small", "bulbous", "lean", "flippers",
                                 "hands",
                                 "hooves", "pads", "paws", "longleg", "longneck", "tail", "chewteeth", "meatteeth",
                                 "buckteeth", "strainteeth", "horns", "claws", "tusks", "smelly", "flys", "hops",
                                 "swims",
                                 "tunnels", "walks", "fast", "slow", "strong", "weak", "muscle", "bipedal",
                                 "quadrapedal",
                                 "active", "inactive", "nocturnal", "hibernate", "agility", "fish", "meat", "plankton",
                                 "vegetation", "insects", "forager", "grazer", "hunter", "scavenger", "skimmer",
                                 "stalker",

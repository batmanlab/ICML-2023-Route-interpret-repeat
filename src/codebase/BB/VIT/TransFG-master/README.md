...
```bash
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.launch --nproc_per_node=4 experiments_BB_CUB_VIT.py --dataset CUB_200_2011 --split overlap --num_steps 10000 --fp16 --name sample_run
```

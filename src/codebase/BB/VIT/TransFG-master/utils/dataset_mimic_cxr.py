...
from .utils_mimic_cxr import get_aug_bbox
    ...
    def __getitem__(self, idx):
        ...
        if self.model_type == "bb" and self.network_type == "VIT":
            ...
            return dicom_id, image, densenet_features, adj_mtx, \
                   ...
                   landmark_bbox
        elif self.model_type == "bb" and self.network_type == "CNN":
            ...
            return dicom_id, image, raw_image, adj_mtx, \
                   chexpert_label, chexpert_inverse_weight, \
                   landmark_spec_label, landmarks_spec_inverse_weight, landmark_spec_label_pnu, \

...
class Dataset_cub_concept(Dataset):
    def __init__(self, dataset, concept_file, transform=None, show_image=False):
        self.dataset = dataset
        self.show_image = show_image
        self.transform = transform
        self.attributes = torch.load(concept_file)
...
class Dataset_cub_waterbird_landbird(Dataset):
    def __init__(self, dataset, attributes, y, transform=None, show_image=False):
        self.dataset = dataset
        self.show_image = show_image
        self.transform = transform
        self.attributes = attributes
...
class Dataset_cub_for_explainer(Dataset):
    def __init__(self, dataset_path, file_name_concept, file_name_y, raw_data, transform=None):
    ...
    def __getitem__(self, item):
        ...
        return image, self.concepts[item], self.y[item], self.y_one_hot[item]

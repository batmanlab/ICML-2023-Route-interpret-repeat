...
from BB.experiments_BB_ISIC import train

sys.path.append(os.path.abspath("/ocean/projects/asc170022p/shg121/PhD/ICLR-2022"))

parser = argparse.ArgumentParser(description='ISIC Training')
...
parser.add_argument('--concept-names', nargs='+',
                    default=["Sex", "BWV", "RegularDG", "IrregularDG", "RegressionStructures",
                             "IrregularStreaks", "RegularStreaks", "AtypicalPigmentNetwork",
                             "TypicalPigmentNetwork"])


def main():
    print("Train BB for SIIM-ISIC")

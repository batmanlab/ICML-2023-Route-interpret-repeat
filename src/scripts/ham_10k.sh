...
# T model 
# train
python ./src/codebase/train_t_ham10k.py  --bs 32 --arch "Inception_V3" > $slurm_output_t_train
...
#---------------------------------
# Train explainer
python ./src/codebase/train_explainer_ham10k.py --iter 1 --expert-to-train "explainer" --dataset "HAM10k" --cov 0.2 --bs 32 --lr 0.01 --temperature-lens 0.7 --lambda-lens 0.0001 --alpha-KD 0.9 --temperature-KD 10 --hidden-nodes 10 --lm 64 --arch "Inception_V3" > $slurm_output_iter1_g_train

# Test explainer
python ./src/codebase/test_explainer_ham10k.py --iter 1 --checkpoint-model "model_g_best_model_epoch_2.pth.tar" --expert-to-train "explainer" --dataset "HAM10k" --cov 0.2 --bs 32 --lr 0.01 --temperature-lens 0.7 --lambda-lens 0.0001 --alpha-KD 0.9 --temperature-KD 10 --hidden-nodes 10 --lm 64 --arch "Inception_V3" >  $slurm_output_iter1_g_test

# Train residual
python ./src/codebase/train_explainer_ham10k.py --iter 1 --checkpoint-model "model_g_best_model_epoch_2.pth.tar" --expert-to-train "residual" --dataset "HAM10k" --cov 0.2 --bs 32 --lr 0.01 --temperature-lens 0.7 --lambda-lens 0.0001 --alpha-KD 0.9 --temperature-KD 10 --hidden-nodes 10 --lm 64 --arch "Inception_V3" > $slurm_output_iter1_residual_train
...
python ./src/codebase/FOLs_vision_main.py --arch "Inception_V3" --dataset "HAM10k" --iterations 6 > $slurm_explanations
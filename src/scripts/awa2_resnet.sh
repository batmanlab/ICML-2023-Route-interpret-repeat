...
python ./src/codebase/train_BB_awa2.py --bs 16 --arch "ResNet101" > $slurm_output_bb_train


# T model 
# train
python ./src/codebase/train_t_awa2.py --checkpoint-file "g_best_model_epoch_[epoch].pth.tar" --bs 32 --layer "layer4" --flattening-type "adaptive" --arch "ResNet101" > $slurm_output_t_train

# Test
python ./src/codebase/test_t_awa2.py --checkpoint-file "g_best_model_epoch_[epoch].pth.tar" --checkpoint-file-t "g_best_model_epoch_199.pth.tar" --save-concepts True --bs 16 --solver-LR "sgd" --loss-LR "BCE" --layer "layer4" --flattening-type "adaptive" --arch "ResNet101"> $slurm_output_t_test
...
python ./src/codebase/FOLs_vision_main.py --arch "ResNet101" --dataset "awa2" --iterations 4 > $slurm_explanations